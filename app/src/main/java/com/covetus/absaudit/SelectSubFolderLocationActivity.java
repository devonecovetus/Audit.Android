...
public class SelectSubFolderLocationActivity extends Activity implements Listener {
    ...
    if(listSource.size()>0){
        ...
        if(meMap.get(listSource.get(i)).equals("0") || meMap.get(listSource.get(i)).equals("")){
            CommonUtils.mShowAlert("Please give count of "+listSource.get(i)+" location",SelectSubFolderLocationActivity.this);
            return;
        }
        }
        ...
        for(int i = 0;i<listSource.size();i++){
            ...
            selectedLocation.setmStrUserId(PreferenceManager.getFormiiId(SelectSubFolderLocationActivity.this));
        ...
        Intent intent = new Intent(SelectSubFolderLocationActivity.this,LocationSubFolder.class);
    ...
    private void initTopRecyclerView() {
        ...
        DragListAdapter topListAdapter = new DragListAdapter(SelectSubFolderLocationActivity.this,topList, this, "0",mAuditId);
    ...
    private void initBottomRecyclerView() {
        ...
        DragListAdapter bottomListAdapter = new DragListAdapter(SelectSubFolderLocationActivity.this,bottomList, this, "1",mAuditId);
