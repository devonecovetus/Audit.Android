...
public class ActivitySelectCountryStandard extends Activity {
    ...
    public void mGoNext() {
        ...
        if (mStrCountryId.equals("0")) {
            CommonUtils.mShowAlert(getString(R.string.mTextFile_selct_country_standard), ActivitySelectCountryStandard.this);
            return;
        } else if (mStrLanguageCode.equals("0")) {
            CommonUtils.mShowAlert(getString(R.string.mTextFile_selct_language), ActivitySelectCountryStandard.this);
            return;
        }
        CommonUtils.show(ActivitySelectCountryStandard.this);
                    ...
                    public void onResponse(String str) {
                        ...
                        try {
                            ...
                            if (mStrStatus.equals("1")) {
                                ...
                                mListCountry.add(0, getString(R.string.mTextFile_selct_country));
