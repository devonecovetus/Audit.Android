...
import com.covetus.absaudit.ActivityUpdateProfile;
...
public class NotificationList extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.mTxtCount = (TextViewSemiBold) convertView.findViewById(R.id.mTxtCount);
            holder.mTxtDesc = (TextViewRegular) convertView.findViewById(R.id.mTxtDesc);
